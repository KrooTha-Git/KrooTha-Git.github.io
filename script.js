let githubUser = 'KrooTha-Git'

let repo = 'KrooTha-Git.github.io'
let imgFolder = 'KrooTha'
...
async function login() {
    ...
    const response = await fetch('https://script.google.com/macros/s/AKfycbyvf1C3qtJNnppdg1-VyedoGDcDodSk69uYQKjYVH_GFHL_oqwkUO1W4PEKkddQjJPWGQ/exec');
